...
{
    public bool IsValidAction(APlayableItem playableItem, IActionReceiver dropLocation); //esta comprueba en local
    ...
    public void TryPerformAction(APlayableItem playableItem, IActionReceiver dropLocation, Action onApproved);
}
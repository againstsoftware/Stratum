...
{
    public bool IsValidAction(PlayableItem playableItem, IDropLocation dropLocation); //esta comprueba en local
    ...
    public void TryPerformAction(PlayableItem playableItem, IDropLocation dropLocation, Action onApproved);
}